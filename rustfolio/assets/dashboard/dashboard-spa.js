...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_30c953c652899bcf = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 584, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 585, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 584, __wbg_adapter_6);
        return ret;
    };
    imports.wbg.__wbindgen_cast_aecf9c132e8cfc96 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 560, function: Function { arguments: [Externref], shim_idx: 561, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 560, __wbg_adapter_16);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_cast_f4b5b256c5e08a43 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 483, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 484, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, 483, __wbg_adapter_9);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dashboard-spa_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
